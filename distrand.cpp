...
void DistRand::_bind_methods() {
	...
	ObjectTypeDB::bind_method("getnext",&DistRand::getnext);
}

float DistRand::dr_boxmuller(const float mu, const float sigma=1.0) { // mu = mean, sigma = standard deviation
